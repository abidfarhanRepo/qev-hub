...
mixin _$TimeSlot {
  ...
  String? get existingBookingId => throw _privateConstructorUsedError;
...
class _$TimeSlotImpl implements _TimeSlot {
  ...
  @override
  String toString() {
    return 'TimeSlot(startTime: $startTime, endTime: $endTime, isAvailable: $isAvailable, reason: $reason, existingBookingId: $existingBookingId)';
  }
