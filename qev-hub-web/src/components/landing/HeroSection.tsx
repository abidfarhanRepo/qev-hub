  ...
  return (
    <section ref={ref} className="relative h-screen w-full overflow-hidden bg-background flex items-center justify-center">
      ...
      <motion.div style={{ y, opacity }} className="absolute inset-0 pointer-events-none flex items-center justify-center">
         ...
         <div className="w-[60vw] h-[60vh] bg-primary/10 blur-[100px] rounded-full mix-blend-screen animate-pulse-slow" />
      </motion.div>
      ...
      <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
        <motion.div
          ...
          className="mb-4 inline-block px-4 py-1.5 border border-primary/30 rounded-full bg-primary/5 backdrop-blur-sm"
        >
          <span className="text-primary text-sm font-medium tracking-widest uppercase">The Future Has Arrived</span>
        </motion.div>
        ...
        <motion.p 
          ...
          className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10 font-light tracking-wide"
        >
          Qatar's Premier Electric Vehicle Ecosystem.
          <br />
          <span className="text-primary font-medium">Sustainable. Connected. Powerful.</span>
        </motion.p>
