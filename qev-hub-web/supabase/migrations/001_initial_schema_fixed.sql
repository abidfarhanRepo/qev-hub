-- Complete Initial Schema for QEV Hub
-- This migration will recreate tables if they exist with wrong schema
...
BEGIN
  ...
  RAISE NOTICE '✓ Vehicles table created with 3 seeded vehicles';
