-- Insert sample charging stations for Qatar
-- This migration populates the charging_stations table with realistic data

INSERT INTO charging_stations (name, address, latitude, longitude, provider, charger_type, power_output_kw, total_chargers, available_chargers, status, operating_hours, pricing_info, amenities) VALUES
(
